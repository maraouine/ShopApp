...
class MyOrdersDetailsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        {
            myOrderDetails=intent.getParcelableExtra<Order>(Constants.EXTRA_ORDER_DETAILS)!!
        }
    ...
    private fun setupUI(orderDetails:Order)
    {
         ...
         //update order stauts : need to develop a backend to handale the order.
        ...
        tv_my_order_details_additional_note.text=orderDetails.address.additionnalNote
